...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    common_vendor.watch(openid, () => {
      where.value.userid = openid.value;
    });
    return (_ctx, _cache) => {
...
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "C:/Users/86189/Desktop/\u524D\u7AEF\u9879\u76EE/ershoujiaoyi/pages/my/myrelease/myrelease.vue"]]);
